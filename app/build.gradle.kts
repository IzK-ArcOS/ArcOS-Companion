...
dependencies {
    ...
    implementation(platform("androidx.compose:compose-bom:2023.10.01")) // og ver: 2023.03.00
    implementation("androidx.compose.ui:ui")
    implementation("androidx.compose.ui:ui-graphics")
    implementation("androidx.compose.ui:ui-tooling-preview")
    implementation("androidx.compose.material3:material3:1.2.0-alpha10") // Remove version if unstable
    ...
    implementation("androidx.work:work-runtime-ktx:$workVersion") // Added for Work (Notifications)
    implementation("androidx.compose.foundation:foundation:1.6.0-alpha08") // Added for DragAnchor (Swipable actions)

    androidTestImplementation("androidx.test.ext:junit:1.1.5")
    androidTestImplementation("androidx.test.espresso:espresso-core:3.5.1")
    androidTestImplementation(platform("androidx.compose:compose-bom:2023.10.01")) // og ver: 2023.03.00
